...
import com.jofrantoba.indiant.server.model.logic.impl.ConfigLogic;
...
public class TestBaseLogic {
    ...
    protected AnnotationConfigApplicationContext contextLogic = new AnnotationConfigApplicationContext(ConfigLogic.class);
