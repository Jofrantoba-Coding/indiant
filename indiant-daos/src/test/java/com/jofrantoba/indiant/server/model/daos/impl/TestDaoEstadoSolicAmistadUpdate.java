 ...
 */
@Log4j2
public class TestDaoEstadoSolicAmistadUpdate {
    ...
    void updateEntity1() throws UnknownException {
        ...
        EstadoSolicAmistad entity = dao.findEntity(null, 1, "R");
        entity.setDescripcion("RECHA");
    ...
    void updateEntity2() throws UnknownException {                
        DaoEstadoSolicAmistad dao = new DaoEstadoSolicAmistad();
        EstadoSolicAmistad entity=dao.findEntity(null, 1, "A");
    ...
    void updateEntity3() throws UnknownException {                
        DaoEstadoSolicAmistad dao = new DaoEstadoSolicAmistad();
        EstadoSolicAmistad entity=dao.findEntity(null, 1, "P");
        entity.setDescripcion("PEN");
