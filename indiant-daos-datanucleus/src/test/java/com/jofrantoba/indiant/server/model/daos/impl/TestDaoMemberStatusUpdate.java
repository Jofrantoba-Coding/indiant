 ...
 */
@Log4j2
public class TestDaoMemberStatusUpdate {
    ...
    void updateEntity1() throws UnknownException {
        ...
        MemberStatus entity = dao.find(null, 1, "R");
        entity.setDescription("RET");
    ...
    void updateEntity2() throws UnknownException {                
        DaoMemberStatus dao = new DaoMemberStatus();
        MemberStatus entity=dao.find(null, 1, "A");
    ...
    void updateEntity3() throws UnknownException {                
        DaoMemberStatus dao = new DaoMemberStatus();
        MemberStatus entity=dao.find(null, 1, "D");
