 ...
 */
@Log4j2
public class TestDaoFriendshipStatusUpdate {
    ...
    void updateEntity1() throws UnknownException {
        ...
        FriendshipStatus entity = dao.find(null, 1, "B");
        entity.setDescription("BLO");
    ...
    void updateEntity2() throws UnknownException {                
        DaoFriendshipStatus dao = new DaoFriendshipStatus();
        FriendshipStatus entity=dao.find(null, 1, "A");
    ...
    void updateEntity3() throws UnknownException {                
        DaoFriendshipStatus dao = new DaoFriendshipStatus();
        FriendshipStatus entity=dao.find(null, 1, "E");
        entity.setDescription("ELI");
