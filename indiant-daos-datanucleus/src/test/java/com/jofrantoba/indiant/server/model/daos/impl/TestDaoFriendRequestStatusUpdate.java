 ...
 */
@Log4j2
public class TestDaoFriendRequestStatusUpdate {
    ...
    void updateEntity1() throws UnknownException {
        ...
        FriendRequestStatus entity = dao.find(null, 1, "R");
        entity.setDescription("RECHA");
    ...
    void updateEntity2() throws UnknownException {                
        DaoFriendRequestStatus dao = new DaoFriendRequestStatus();
        FriendRequestStatus entity=dao.find(null, 1, "A");
        entity.setDescription("ACT");
    ...
    void updateEntity3() throws UnknownException {                
        DaoFriendRequestStatus dao = new DaoFriendRequestStatus();
        FriendRequestStatus entity=dao.find(null, 1, "P");
        entity.setDescription("PEN");
